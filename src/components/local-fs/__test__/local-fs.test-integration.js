...
test('localFSComponent should create store directory if it is not exists', async () => {
...
test('LocalFS#save should throw if filename is invalid', async t => {
...
test('LocalFS#save should save file to storage', async t => {
...
test('LocalFS#save should increase filename counter if filename already exists in storage', async t => {
